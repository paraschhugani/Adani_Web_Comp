...
urlpatterns = [
    ...
    path('departments/<int:dpt_code>', views.departments_det, name='departments_det'),

#     Payment and Registration for courses
    path('access/<int:code>/', views.access, name='access'),

#     Payment handler
    path('paymenthandler/<int:code>/', views.paymenthandler, name='paymenthandler'),

#     Course Remover
     path('remove/<int:code>/', views.remove, name='remove'),
